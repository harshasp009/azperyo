...
class __TwigTemplate_a3bcf79e294f27b07a46fb690339f6e46da94f44efc7ff379147f092ba65298c extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 1
        if (($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "disabled", array()) != 1)) {
            // line 2
            echo "<div class=\"md-slide-item ";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["index"]) ? $context["index"] : null), "html", null, true));
            echo "\" ";
...
<div class=\"md-main-img\" style=\"";
            // line 3
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["background_style"]) ? $context["background_style"] : null), "html", null, true));
            echo "\">
    ...
    ";
            ...
            if ((isset($context["background_url"]) ? $context["background_url"] : null)) {
                // line 6
                echo "        <img src=\"";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["background_url"]) ? $context["background_url"] : null), "html", null, true));
                echo "\" alt=\"";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "background_image_alt", array())));
                echo "\" ";
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["background_style"]) ? $context["background_style"] : null), "html", null, true));
                echo " />
    ";
...
";
            ...
            if ($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "background_overlay", array())) {
                ...
                echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "background_overlay", array()), "html", null, true));
                echo "\">
</div>
";
            }
...
";
    ...
    {
        return new Twig_Source("{% if settings.disabled != 1 %}
...
", "modules/contrib/md_slider/templates/frontend/front-slide-render.html.twig", "/private/var/www/azforyou/modules/contrib/md_slider/templates/frontend/front-slide-render.html.twig");
    }
}
